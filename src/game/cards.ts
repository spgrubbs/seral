...
export const EVENT_CARDS: Card[] = [
  {
    ...
    name: 'Good Rain Year',
    type: 'event',
    description: 'The skies open generously.',
    cost: { biomass: 0, nutrients: 0, water: 0 },
    incomePerTurn: { biomass: 0, nutrients: 0, water: 0 },
    tags: [],
    placement: {},
...

  {
    ...
    type: 'event',
    description: 'An extraordinary year of seed production.',
    cost: { biomass: 0, nutrients: 0, water: 0 },
    incomePerTurn: { biomass: 0, nutrients: 0, water: 0 },
    tags: [],
    placement: {},
...

  {
    ...
    name: 'Warm Winter',
    type: 'event',
    description: 'A mild winter lets life flourish.',
    cost: { biomass: 0, nutrients: 0, water: 0 },
    incomePerTurn: { biomass: 0, nutrients: 0, water: 0 },
    tags: [],
    placement: {},
...

  {
    ...
    type: 'event',
    description: 'Biological soil crusts stabilize the ground.',
    cost: { biomass: 0, nutrients: 0, water: 0 },
    incomePerTurn: { biomass: 0, nutrients: 0, water: 0 },
    tags: [],
    placement: {},
